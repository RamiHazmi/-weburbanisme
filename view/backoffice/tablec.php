			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
                          ...
                          <?php
// Start by debugging if $covoiturages is set and not NULL

?>
<div class="col-md-12">  
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title">Covoiturages</h2>
        </header>
        <div class="panel-body">
            <div class="table-responsive">
                <?php
                if (is_array($covoiturages) && count($covoiturages) > 0) {
                    ...
                    foreach ($covoiturages as $covoiturage) {
                        ...
                        echo "<td> 
                                <button class='modifier-btn'
                                    data-id='" . htmlspecialchars($covoiturage['id_trajet']) . "'
                                    data-depart='" . htmlspecialchars($covoiturage['depart']) . "'
                                    data-destination='" . htmlspecialchars($covoiturage['destination']) . "'
                    ...
                    echo "<p>No covoiturages found.</p>";
                }
                ?>
            </div>
        </div>
...
<div id="confirmation-dialog" style="
    display: none;
    position: fixed;
    top: 50%;
    left: 50%;
    ...
    z-index: 1000;
">
    <p style="font-size: 16px; margin-bottom: 20px;">Êtes-vous sûr de vouloir supprimer ce covoiturage&nbsp;?</p>
    <button id="yes-delete" style="
...
<script src="supprimercovoiturage.js"></script>
...
<div id="modification-form">
    ...
    <form id="updateForm" enctype="multipart/form-data">
        <input type="hidden" id="id_trajet" name="id_trajet" value="some_value">
        <label>Départ:</label>
        <input type="text" id="depart" name="depart"><br>
        <label>Destination:</label>
        <input type="text" id="destination" name="destination"><br>
        <label>Date et Heure:</label>
        <input type="datetime-local" id="date_heure" name="date_heure"><br>
        <label>Tarif:</label>
...
<script src="modifiercovoiturage.js"></script>
