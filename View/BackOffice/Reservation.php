    ...
    <?php if (!empty($liste)) : ?>
                <?php foreach ($liste as $row) : ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row["prenomClient"]) ?></td>
                        ...
                        <td><?= htmlspecialchars($row["statut_reservation"]) ?></td>
                    
                        <td>
                            <a href="telecharger_event.php?id_reservation=<?= $row['id_reservation'] ?>" style="color:green;">Ajouter à Google Agenda</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
...
<div style="text-align: center; margin-top: 20px;">
    <a href="https://calendar.google.com" target="_blank">
        <button class="btn btn-primary">Voir Google Agenda</button>
    </a>
</div>
